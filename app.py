...
# --- CSS TÙY CHỈNH CHUNG & MẶT NẠ ẨN TÊN ---
st.markdown("""
    ...
    /* KHUNG CHỨA HEADER TRANG WELCOME */
    .header-container { 
...
# =====================================================================
# TRANG 1: ĐĂNG NHẬP (CĂN GIỮA + KHÓA CUỘN)
# =====================================================================
...
# =====================================================================
# TRANG 2: CHÀO MỪNG (CĂN GIỮA + KHÓA CUỘN)
# =====================================================================
elif st.session_state.current_page == "welcome":
    # Áp dụng cùng CSS căn giữa và khóa cuộn như trang Login
    st.markdown("""
        <style>
        [data-testid="stAppViewContainer"] { overflow: hidden !important; }
        [data-testid="stMainBlockContainer"] {
...
# =====================================================================
# TRANG 3: ĐÁNH GIÁ (CHO PHÉP CUỘN BÌNH THƯỜNG)
# =====================================================================
elif st.session_state.current_page == "evaluation":
    # Không thêm CSS justify-content để trang này có thể cuộn tự nhiên
    ...
    if selected_site != "-- Chọn Site --" and selected_dept != "-- Chọn Bộ phận --" and evaluator_name:
        ...
        with l_col:
            ...
            st.progress(len(st.session_state.evaluated_nccs)/len(list_ncc))
